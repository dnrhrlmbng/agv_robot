...
def generate_launch_description():
    pkg_urdf_path = FindPackageShare('agv_robot_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_urdf_path, 'rviz', 'agv_robot_description.rviz'])
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'agv_robot_description',
